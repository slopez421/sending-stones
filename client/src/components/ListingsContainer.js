...
function ListingsContainer({likes, listings, refreshPage, setRefreshPage, user}) {
    return <div>
        ...
        <ListingCard listing={listing} likes={likes} refreshPage={refreshPage} setRefreshPage={setRefreshPage} currentUser={user}/>
        </div>
        )}
        </div>
